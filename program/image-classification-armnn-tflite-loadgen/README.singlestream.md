...
- Set up [`program:image-classification-armnn-tflite-loadgen`](https://github.com/ctuning/ck-ml/blob/master/program/image-classification-armnn-tflite-loadgen/README.md) on your SUT.
